...
화살표 함수(arrow function)는 단순히 함수를 '짧게' 쓰기 위한 용도로 사용되지 않습니다.
...
*!*
    this.students.forEach(
      // 화살표 함수를 사용했기 때문에 this.title은 group.title과 같습니다.
      // 화살표 함수 사용 ()=>()
...
*!*
    ...
    this.students.forEach(function(student) {
      ...
      // this 는 undefined 이 되었습니다. // 화살표 함수는 this 자체가 없기 때문에 이런 에러가 발생하지 않습니다.
